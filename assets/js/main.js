const translations = {
  ru: {
    ...
    "sc.page.title":    "Закваска-кулинар — помощник пекаря",
    ...
    "sc.page.about.p":  "Закваска-кулинар помогает домашним пекарям управлять каждым этапом выпечки хлеба на закваске.",
    ...
    "sc.support.back":     "← Закваска-кулинар",
    "sc.support.page.title": "Поддержка — Закваска-кулинар",
    "sc.support.label":    "Помощь",
    "sc.support.title":    "Поддержка",
    "sc.support.sub":      "Ответы на частые вопросы о Закваска-кулинар. Если не нашли нужного — напишите мне напрямую.",
    "sc.support.q1":       "Таймер не отображается на Dynamic Island — что делать?",
    "sc.support.a1":       "Убедитесь, что уведомления разрешены для приложения: Настройки → Уведомления → Закваска-кулинар. Live Activity работает только на iPhone 14 Pro и новее.",
    ...
    "sc.privacy.back":     "← Закваска-кулинар",
    "sc.privacy.page.title": "Политика конфиденциальности — Закваска-кулинар",
    ...
    "sc.privacy.p1":       "Закваска-кулинар не собирает, не хранит и не передаёт никакие персональные данные. Все данные (рецепты, таймеры, настройки) хранятся исключительно на вашем устройстве.",
    ...
    "sc.tos.back":     "← Закваска-кулинар",

    "sc.tos.s1.h": "1. Принятие условий",
    "sc.tos.s1.p": "Загружая или используя Закваска-кулинар, вы соглашаетесь с настоящими Условиями использования. Если вы не согласны, пожалуйста, не используйте приложение.",

    "sc.tos.s2.h": "2. Описание сервиса",
    "sc.tos.s2.p": "Закваска-кулинар — помощник по выпечке на закваске для iPhone. Приложение помогает управлять рецептами, отслеживать таймеры ферментации и следовать пошаговым инструкциям.",
  ...
  en: {
    ...
    "sc.page.title":    "Sourdough Cooker — Baking Assistant",
    ...
    "sc.page.about.p":  "Sourdough Cooker helps home bakers manage every stage of sourdough bread making.",
    ...
    "sc.support.page.title": "Support — Sourdough Cooker",
    "sc.tos.s8.p": "Questions? Reach us via the <a href=\"../support/\">support page</a>.",
    "sc.support.back":      "← Sourdough Cooker",
    "sc.support.label":    "Help",
    "sc.support.title":    "Support",
    "sc.support.sub":      "Answers to common questions about Sourdough Cooker. If you can't find what you're looking for, reach out directly.",
    "sc.support.q1":       "The timer isn't showing on the Dynamic Island — what should I do?",
    "sc.support.a1":       "Make sure notifications are enabled in Settings → Notifications → Sourdough Cooker. Live Activities only work on iPhone 14 Pro and later.",
    ...
    "sc.privacy.back":     "← Sourdough Cooker",
    "sc.privacy.page.title": "Privacy Policy — Sourdough Cooker",
    ...
    "sc.privacy.p1":       "Sourdough Cooker does not collect, store, or transmit any personal data. All data (recipes, timers, preferences) is stored locally on your device only.",
    ...
    "sc.tos.back":     "← Sourdough Cooker",

    "sc.tos.s1.h": "1. Acceptance",
    "sc.tos.s1.p": "By downloading or using Sourdough Cooker, you agree to these Terms of Service. If you do not agree, please do not use the app.",

    "sc.tos.s2.h": "2. Description of Service",
    "sc.tos.s2.p": "Sourdough Cooker is a baking assistant app for iPhone that helps you manage sourdough recipes, track fermentation timers, and follow step-by-step baking instructions.",
